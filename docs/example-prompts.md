...
These prompts show what you can ask your AI assistant when working with MainWP. They're starting points, not a complete list. Once you get comfortable with the basics, you'll find your own patterns for how you like to work. The AI understands natural language, so feel free to phrase things however makes sense to you.
...
These cover the day-to-day tasks most agencies run regularly:
...
Checking for and applying updates is one of the most common workflows:
...
Keep an eye on vulnerabilities and security status across your network:
...
When something goes wrong, these prompts help you diagnose the issue:
...
Managing clients, tags, and how your sites are organized:
...
Working across many sites at once:
...
Getting overviews and summaries of your network:
...
**Be specific when you can.** "Update Elementor on example.com" works better than "update that plugin."

**Use site names or URLs.** The AI can find sites by their name, URL, or domain.
